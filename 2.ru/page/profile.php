...
if($_SESSION['USER_BREED'] == 0) $breed = 'Не сказал!';
if($_SESSION['USER_BREED'] == 1) $breed = 'Белая';
if($_SESSION['USER_BREED'] == 2) $breed = 'Темная';
if($_SESSION['USER_BREED'] == 3) $breed = 'Лысая';
if($_SESSION['USER_BREED'] == 4) $breed = 'Тигровая';
...
<br>Порода Вашего Кота/Кошки '.$breed.'
...
<br><select size="1" name="breed">'.str_replace('>'.$_SESSION['USER_BREED'], 'selected>'.$_SESSION['USER_BREED'], '<option value="0">Не скажу</option><option value="1">Белая</option><option value="2">Черный нигер</option><option value="3">Лысик</option><option value="4">А х его знает</option>').'</select>
